...
from predictv3 import diagnose, fuzzy_match, feature_cols
import qrcode
import base64
...
def diagnose_route():
    ...
    # ---- Get final predicted disease ----
    disease = diagnose(symptoms_text)

    # ---- Build cleaned fuzzy-matched symptom list ----
    cleaned = []
    raw = (
        symptoms_text.lower()
        .replace(" and ", ",")
...
if __name__ == "__main__":
    print("🚀 Doctor Assistant Backend Running at http://localhost:5000")
